#include "../includes/FelizNatal.h"

FelizNatal::FelizNatal()
{
...
int FelizNatal::imprimeFelizNatal( Teclado *tec  )
{
    ...
    al_draw_text(fonte, al_map_rgb(0, 0, 0), SCREEN_W/2, SCREEN_H/2, ALLEGRO_ALIGN_CENTRE, "You can't be saved :)");
